...
//    myButton7.innerHTML = myTextArea.value;
//});
...
//    myWindow = window.open("newpage.html", myWindow, "width=300, height=300");
//    resizeWin();
//});
//
//function resizeWin() {
//    window.myWindow.resizeTo(500,300);
//}
...
//}
//
//buttonOne.addEventListener("click", startEvent, false);
//buttonTwo.addEventListener("click", stopEvent, false);
...
//function myFunction() {
//    var x = document.getElementById("favorite").selectedIndex;
//    var y = document.getElementById("favorite").options;
//    alert(y[x].text);
//}
//    
//selection.addEventListener("click", myFunction, false);
